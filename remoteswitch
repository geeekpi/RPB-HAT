...
shutdown_signal_pin=1

#This pin is based on wringPi mode, and  it will initialize the reboot procedure when it's levle is
# HIGH.
reboot_signal_pin=0
